...
\caption[Hypothetical net reactions to form a phospholipid and an aminolipid from a set of basis species]{A hypothetical depiction of the net process of autotrophic uptake of nutrients and biosynthesis of a phospholipid (top right) and an aminolipid (bottom right) by a microbial community. In these reactions, lipids are formed from a set of basis species (left) that includes phosphate (HPO\textsubscript{4}\textsuperscript{2-}), bicarbonate (HCO\textsubscript{3}\textsuperscript{-}), ammonium (NH\textsubscript{4}\textsuperscript{+}), protons (H\textsuperscript{+}), and electrons (e\textsuperscript{-}), with water (H\textsubscript{2}O) as a byproduct.  Lipid headgroups, backbones, and alkyl chains are shown in green, blue, and orange, respectively, within the lipid chemical structures. The lipid structures depicted here differ only by their headgroups.}
