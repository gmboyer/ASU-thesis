...
In this study, we quantified structures of BHPs in thermophilic microbial communities sampled along the thermal and redox gradients of four YNP hot springs, Bison Pool (BP), Mound Spring (MS), Empress Pool (EP), and Octopus Spring (OS). We then estimated the aqueous thermodynamic properties of six BHP headgroups, including tetrol, pentol, hexol, aminotriol, aminotetrol, and aminopentol, as well as the properties of the ionized amminium forms of the aminopolyols, including amminiumtriol, amminiumtetrol, and amminiumpentol. Estimations of BHP headgroup thermodynamic properties were performed independently of observations in hot spring samples and were based entirely on thermodynamic measurements of organic molecules reported in the literature. Estimated BHP headgroup properties were then used in conjunction with measurements of hot spring temperature and chemical composition to predict equilibrium speciation of aqueous BHP headgroups along an Eh gradient, following the same principles one would use to predict aqueous carbonate speciation along a pH gradient. Relative abundance of BHP headgroups were then compared to these independent thermodynamic predictions of aqueous BHP headgroup speciation. Much like using measured abundances of carbonate species to predict pH, measured abundances of BHP headgroups were used to predict Eh in each sample. BHP headgroup-predicted Eh values (Eh\textsubscript{BHP,head}) were compared to Eh values previously reported for this sample set (Chapter \ref{ch2}) and were found to have the highest linear correlation with those calculated from the O\textsubscript{2}/H\textsubscript{2}O redox couple.
...
Approach to equilibrium in 




in an effort to save cellular energy
