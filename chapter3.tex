...
\caption[Weighted Z\textsubscript{C} of thermophile lipid components as a function of temperature and dissolved oxygen concentration]{Weighted Z\textsubscript{C} of thermophile lipid components as a function of temperature and dissolved oxygen concentration. Black symbols indicate BHP headgroups, and white symbols indicate IPL headgroups. Empty symbols indicate IPL alkyl chains. Values for Z\textsubscript{C} of IPL are from Chapter \ref{ch1}. Unweighted linear models were used to generate R\textsuperscript{2} values.}
\label{fig:BHP_ZC}
\end{figure}
\doublespace
\clearpage
