...
BHP headgroups exhibit a variety of structures. The C35 terminus of the headgroup can be ``decorated" with a hydroxyl group or an amine. The number of headgroup hydroxylations can vary, resulting in 4, 5, or 6 total functional groups. Other organic molecules called `composite groups', such as cyclitol and glucosamine amino sugars, have been shown to link to the headgroups of some BHPs. Intriguingly, the specific functions served by BHP headgroup structures are still generally undiscovered \citep{belin2018hopanoid}. I wanted to use this to my advantage; by treating each BHP headgroup as functionally equivalent, I wanted to know how well thermodynamic equilibrium could predict their distributions with respect to temperature and chemical composition of the surroundings.
