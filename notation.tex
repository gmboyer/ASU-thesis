...
\begin{sortedgloss}
    \gloss{1G : monoglycosyl}
    \gloss{2G : diglycosyl}
    \gloss{3G : triglycosyl}
    \gloss{2G-NAcG-G : diglycosyl (N-acetyl)glycosaminyl glycosyl}
    \gloss{3G-NAcG-G : triglycosyl (N-acetyl)glycosaminyl glycosyl}
    \gloss{4G : tetraglycosyl}
    \gloss{GA : glycoronic acid}
    \gloss{G-GA : glycoronic acid}
    \gloss{G-NG : monoglycosyl (N)glycosaminyl}
    \gloss{NG-GA : (N)glycosaminyl glycoronic acid}
    \gloss{SQ : sulfoquinovosyl}
\end{sortedgloss}
