...
I found that along the thermal and redox gradients of all four hot springs, the abundance-weighted Z\textsubscript{C} of thermophile IPLs increased gradually (more oxidized carbon) from upstream to downstream, \textit{i.e.}, from the hot spring source, coinciding with decreased temperatures and increased oxidation potential of dissolved inorganic solutes, such as O\textsubscript{2}. Furthermore, I found that changes in alkyl chain modifications, like the number of aliphatic carbons, the degree of unsaturation, chain-backbone linkage chemistry, and inclusion of rings in the alkyl chains of glycerol dialkyl glycerol tetraethers (GDGTs), were most responsible for the observed increase in lipid oxidation state downstream.
...
\caption[Number of aliphatic carbons (nC) per IPL alkyl chain as a function of temperature]{Number of aliphatic carbons (nC) per IPL alkyl chain as a function of temperature. Points are the average weighted value, rectangles show the interquartile range (IQR) of observed values, with 25\% of observations lying above and below the black middle line, representing the median value, with whiskers encompassing observations up to 1.5 times the IQR beyond this range. Values that fall outside the range of the whiskers are not indicated. Best-fit lines indicate an abundance-weighted least-squares regression of all observations.}
\label{fig:nC}
\end{figure}
\doublespace
\clearpage
...
\caption[Number of unsaturations (nUnsat) per IPL alkyl chain]{Number of unsaturations (nUnsat) per IPL alkyl chain. Refer to the caption of Figure \ref{fig:nC} for a description of the symbols and statistics used in this plot.}
\label{fig:nUnsat}
\end{figure}
\doublespace
\clearpage
...
\caption[Number of internal rings per GDGT]{Number of internal rings per GDGT. Refer to the caption of Figure \ref{fig:nC} for a description of the symbols and statistics used in panels A-D. Linear regression of the abundance-weighted number of internal rings per GDGT across all samples is shown in panel E as a function of temperature (left) and dissolved oxygen concentration (right).}
\label{fig:nRings}
\end{figure}
\doublespace
\clearpage
