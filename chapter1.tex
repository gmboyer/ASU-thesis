...
\caption[Number of aliphatic carbons (nC) per IPL alkyl chain]{Number of aliphatic carbons (nC) per IPL alkyl chain. Points are the average weighted value, nC; box and whisker plots indicate distributions of individual IPL observations at each sample site, the black horizontal bar in each box is the median value.}
\label{fig:nC}
\end{figure}
\doublespace
\clearpage
