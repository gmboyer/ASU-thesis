...
\section{Predicted relative abundance of sample-averaged free alkyl chains and Eh\textsubscript{alkyl}}

Figure \ref{fig:bison_thermo} shows the predicted relative abundances of sample-averaged free alkyl chains of Bison Pool as a function of Eh. The calculation shown in Figure \ref{fig:BP1_thermo} shows the predicted abundances at the temperature and basis species concentrations measured for sample BP1. 
...
% regarding the use of thermodynamic models to predict biological trends
