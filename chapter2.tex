...
Various abundance-weighted properties of alkyl chains such as nC (number of aliphatic carbons), nUnsat (number of unsaturations), nOH (number of secondary hydroxylations), backbone-chain linkage types (ether, ester, amide, and C-C), and chemical formulae were calculated from observed abundances of IPLs in Chapter \ref{ch1} with Equation \ref{eq:avechain}. These properties, which are reported in Table \ref{tab:IPL_ZC},
