...
% Chemical formulae and estimated thermodynamic properties of sample averaged free chains are reported in table. (that's it, really)

% Example reaction from basis species (BP1). What does this look like? (if time, example reaction at MS5)
