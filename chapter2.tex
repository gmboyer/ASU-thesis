...
In observed distributions of IPLs sampled from microbial communities across the temperature and redox gradients of four alkaline hot springs in YNP, it was observed that IPL-linked alkyl chains with reduced structural modifications were most abundant in hot, reducing upstream conditions, while those with oxidized modifications were most abundant in oxidized downstream conditions (Chapter \ref{ch1}). It was hypothesized that these changes were the result of adaptation to the temperature and geochemistry of the system as a whole, and that oxidized and reduced alkyl chain modifications trended in such a way that was energetically favorable. The results of this study show that simplified molecules representing entire lipid distributions are predicted to speciate along a simulated redox gradient at hot spring temperatures and chemical compositions. The formation of alkyl\textsubscript{free} representative of lipid distributions sampled from upstream hot, reducing conditions, were favored in reduced Eh regimes. Likewise, alkyl\textsubscript{free} of downstream sites were predicted to be most stable in oxidized conditions. Further, the Eh values that predicted maximal abundances of alkyl\textsubscript{free} were always in the order of most reduced to most oxidized for upstream to downstream samples, respectively. This suggests that the upstream to downstream changes observed in IPL distributions not only provide thermostable membranes for microbial communties, but fulfill this function by incorporating structural changes into alkyl chains that are energetically favorable along a simulated Eh gradient.

subtleties that are not predictable from ZC alone: out-of-order ZC was still had max abundance within-order along Eh gradients.



% end with: what about headgroups? Next step try thermo estimation of headgroup stability.
